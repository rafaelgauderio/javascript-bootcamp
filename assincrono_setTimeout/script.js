...
console.log("setTimeout faz um espera assíncrona. Ou seja o código segue executando enquanto não der o tempo da função que é chamada como referência no setTimeout");
